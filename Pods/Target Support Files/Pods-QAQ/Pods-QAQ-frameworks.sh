...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LetMeAuth/LetMeAuth.framework"
  install_framework "$BUILT_PRODUCTS_DIR/LetMeAuth-FacebookSDK-iOS/LetMeAuth_FacebookSDK_iOS.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SCTableViewCell/SCTableViewCell.framework"
